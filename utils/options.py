...
def args_parser():
    ...
    parser.add_argument('--execute', type=str, default='onedevice', help="Strategy")
    parser.add_argument('--T', type=int, default=5000, help="T")
    parser.add_argument('--po', type=float, default=0.003, help="power")
    ...
    parser.add_argument('--setting', type=int, default=1, help="seed_number")
